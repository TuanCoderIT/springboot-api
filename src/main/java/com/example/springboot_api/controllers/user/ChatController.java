...
import com.example.springboot_api.services.user.ChatService;
...
public class ChatController {
    ...
    public void sendMessage(
        ...
        if (principal == null) {
            log.error("Unauthorized: Principal is null for chat.send");
            return;
        }
    ...
    public void reactToMessage(
        ...
        if (principal == null) {
            log.error("Unauthorized: Principal is null for chat.react");
            return;
        }
    ...
    public void handleTyping(
        ...
        if (principal == null) {
            log.error("Unauthorized: Principal is null for chat.typing");
            return;
        }
        ...
        try {
            ...
            String normalizedAvatarUrl = urlNormalizer.normalizeToFull(user.getAvatarUrl());
